...
{
    "sora_prompt": "Simple, natural prompt. Focus entirely on the core action, environment, and era. No technical camera directions, complex scenery, or excessive detail. Max 50 words.",
    "motion_prompt": "4-9 second seamless loop instructions. Gentle, natural motion like drifting, swaying, or flickering. Keep it minimal. Max 35 words.",
